...
> โดยตัวอย่างทั้ง 3 ตัวนี้แสดงให้เห็นว่าภาษา Java กับ C++ จะมีความคล้ายคลึงกันมากและจะมีคีย์เวิร์ด private แต่ในทางกลับกันภาษา Dart กับ Python นั้นจะไม่มีคีย์เวิร์ดแต่จะแทนด้วยเครื่องหมาย (_)
